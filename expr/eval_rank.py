...
def report_best_epoch():
  ...
  # log_dir = os.path.join(root_dir, 'rnnve_orth_expr', 'i3d_resnet200.512_512_512.250.gru.max.0.5.0.1.flickr30m.finetune.direct', 'log')
  # log_dir = os.path.join(root_dir, 'rnnve_orth_expr', 'i3d_i3d_flow_resnet200.512_512_512.250.gru.max.0.5.0.1.flickr30m.freeze.direct', 'log')
  ...
  log_dir = os.path.join(root_dir, 'aca_expr', 'i3d_i3d_flow_resnet200.500.0.5.0.1.att.flickr30m.feedforward', 'log')
  ...
  # log_dir = os.path.join(root_dir, 'aca_parallel_expr', 'i3d_resnet200.500.0.5.0.1.att.flickr30m', 'log')
...
def predict_eval_trecvid17_B():
  ...
  # root_dir = '/home/jiac/data/trecvid2018/rank' # gpu8
  # root_dir = '/home/jiac/data/trecvid2018/rank' # gpu9
  # ft_names = ['i3d', 'i3d_flow', 'resnet200']
  ...
  annotation_file = os.path.join(root_dir, 'split', 'tst_id_caption_mask.E.pkl')
  out_name = 'tst.E'
  ...
  # # expr_name = os.path.join(root_dir, 'rnnve_expr', 'i3d_i3d_flow_resnet200.500.250.gru.max.0.5.0.1.lifted.flickr30m.l2norm_input')
  # expr_name = os.path.join(root_dir, 'rnnve_expr', 'i3d_resnet200.500.250.gru.max.0.5.0.1.lifted.0.3.flickr30m')
  # # expr_name = os.path.join(root_dir, 'rnnve_expr', 'i3d_resnet200.500.250.gru.max.0.5.0.1.lifted.0.5.flickr30m')
  # log_dir = os.path.join(expr_name, 'log')
  # model_cfg_file = '%s.model.json'%expr_name
  # path_cfg_file = '%s.path.json'%expr_name
  ...
  # expr_name = os.path.join(root_dir, 'rnnve_orth_expr', 'i3d_resnet200.512_512_512.250.gru.max.0.5.0.1.flickr30m.finetune.direct')
  # expr_name = os.path.join(root_dir, 'rnnve_orth_expr', 'i3d_i3d_flow_resnet200.512_512_512.250.gru.max.0.5.0.1.flickr30m.freeze.direct')
  log_dir = os.path.join(expr_name, 'log')
  model_cfg_file = '%s.model.json'%expr_name
  path_cfg_file = '%s.path.json'%expr_name
  ...
  # expr_name = os.path.join(root_dir, 'aca_expr', 'i3d_i3d_flow_resnet200.500.0.5.0.1.att.flickr30m.feedforward')
  # log_dir = os.path.join(expr_name, 'log')
  # model_cfg_file = '%s.model.json'%expr_name
  # path_cfg_file = '%s.path.json'%expr_name
