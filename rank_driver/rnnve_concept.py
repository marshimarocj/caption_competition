...
WE = rank_model.rnnve_concept.WE
RNN = rank_model.rnnve_concept.RNN
CELL = rank_model.rnnve_concept.CELL
RCELL = rank_model.rnnve_concept.RCELL
...
if __name__ == '__main__':
  ...
  m = rank_model.rnnve_concept.Model(model_cfg)
  ...
  if opts.is_train:
    ...
    tst_reader = rank_model.rnnve_concept.TstReader(opts.ft_files.split(','), opts.annotation_file)
