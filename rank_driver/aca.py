...
if __name__ == '__main__':
  ...
  m = rank_model.aca.Model(model_cfg)

  if opts.is_train:
    trntst = rank_model.aca.TrnTst(model_cfg, path_cfg, m)

    trn_reader = rank_model.aca.TrnReader(
    ...
    val_reader = rank_model.aca.ValReader(
    ...
    tst_reader = rank_model.aca.TstReader(opts.ft_files.split(','), opts.annotation_file)
