...
if __name__ == '__main__':
  ...
  m = rank_model.vevd_score.Model(model_cfg)

  if opts.is_train:
    trntst = rank_model.vevd_score.TrnTst(model_cfg, path_cfg, m)

    trn_reader = rank_model.vevd_score.TrnReader(
    ...
    val_reader = rank_model.vevd_score.ValReader(
    ...
    tst_reader = rank_model.vevd_score.TstReader(opts.ft_files.split(','), opts.annotation_file)
