...
if __name__ == '__main__':
  ...
  m = rank_model.ceve_score.Model(model_cfg)

  if opts.is_train:
    trntst = rank_model.ceve_score.TrnTst(model_cfg, path_cfg, m)
    ...
    tst_reader = rank_model.ceve_score.TstReader(opts.ft_files.split(','), opts.annotation_file)
