...
import rank_model.rnnve_embed
import common

WE = rank_model.rnnve_embed.WE
RNN = rank_model.rnnve_embed.RNN
CELL = rank_model.rnnve_embed.CELL
RCELL = rank_model.rnnve_embed.RCELL
...
if __name__ == '__main__':
  ...
  m = rank_model.rnnve_embed.Model(model_cfg)
  ...
  trntst = rank_model.rnnve_embed.TrnTst(model_cfg, path_cfg, m)

  tst_reader = rank_model.rnnve_embed.TstReader(opts.ft_files.split(','), opts.annotation_file)
