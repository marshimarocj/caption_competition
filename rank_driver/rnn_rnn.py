...
WE = rank_model.rnn_rnn.WE
RNN = rank_model.rnn_rnn.CAPTION_RNN
CELL = rank_model.rnn_rnn.CELL
RCELL = rank_model.rnn_rnn.RCELL
...
if __name__ == '__main__':
  ...
  m = rank_model.rnn_rnn.Model(model_cfg)
