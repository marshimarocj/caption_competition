...
if __name__ == '__main__':
  ...
  m = rank_model.align.PGModel(model_cfg)

  if opts.is_train:
    trntst = rank_model.align.PGTrnTst(model_cfg, path_cfg, m)

    trn_reader = rank_model.align.TrnReader(
    ...
    val_reader = rank_model.align.ValReader(
    ...
    trntst = rank_model.align.TrnTst(model_cfg, path_cfg, m)

    tst_reader = rank_model.align.TstReader(
      opts.ft_files.split(','), opts.att_ft_files.split(','), opts.annotation_file)
