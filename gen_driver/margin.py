...
if __name__ == '__main__':
  ...
  if opts.is_train:
    ...
    trn_reader = gen_model.margin.TrnReader(
      model_cfg.num_neg, path_cfg.trn_ftfiles, path_cfg.trn_videoid_file,
      path_cfg.trn_annotation_file, path_cfg.groundtruth_file, path_cfg.word_file, model_cfg.metric)
    val_reader = gen_model.margin.Reader(
