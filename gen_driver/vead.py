...
if __name__ == '__main__':
  ...
  if opts.is_train:
    ...
    trntst = gen_model.vead.TrnTst(model_cfg, path_cfg, m)

    trn_reader = gen_model.vead.Reader(
      path_cfg.trn_ftfiles, path_cfg.trn_att_ftfiles, path_cfg.trn_videoid_file,
      shuffle=True, annotation_file=path_cfg.trn_annotation_file)
    val_reader = gen_model.vead.Reader(
      path_cfg.val_ftfiles, path_cfg.val_att_ftfiles, path_cfg.val_videoid_file,
    ...
    tst_reader = gen_model.vead.Reader(
      path_cfg.tst_ftfiles, path_cfg.tst_att_ftfiles, path_cfg.tst_videoid_file)
